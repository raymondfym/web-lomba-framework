            ...
            <div class="row">
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
                        ...
                        <h1 class="h1-large">Lomba Tingkat Nasional</h1>
                        <p class="p-large">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut dignissim, neque ut ultrices sollicitudin</p>
                        <a class="btn-solid-lg-primary" href="#">Pendaftaran</a>
                        <a class="btn btn-solid-lg-secondary" href="#">Login</a>
                        <!-- <a class="quote" href="#contact"><i class="fas fa-paper-plane"></i>Get quote</a> -->
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="images/codeReview.svg" alt="alternative">
    ...
    <div id="about" class="basic-1">
        <div class="container mt-5">
            <div class="row">
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="images/goodTeam.svg" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
                <div class="col-lg-6 col-xl-5">
                    <div class="text-container">
        ...
        <div class="container mt-3">
            <div class="row">
                <div class="d-flex justify-content-center">
                    <h2 class="h2-heading"><span>Lomba Nasional</span><br> Ilmu Komputer</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="d-flex justify-content-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="images/decoration-lines.svg" alt="alternative"><span>Lomba 1</span><img class="decoration-lines flipped" src="images/decoration-lines.svg" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
                            ...
                            <a href="#" class="btn-solid-reg-primary">Sign Up</a>
                        </div>
                    </div>
                    <!-- end of card -->
